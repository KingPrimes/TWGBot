...
public class TextElement extends CombineElement<TextElement> {
    ...
    private java.util.List<TextElement> breakLineElements;
    ...
    public java.util.List<TextElement> getBreakLineElements() {
    ...
    private java.util.List<TextElement> computeBreakLineElements() {
        java.util.List<TextElement> breakLineElements = new ArrayList();
        java.util.List<String> breakLineTexts = this.computeLines(this.text);
        int currentY = this.getY();

        for (int i = 0; i < breakLineTexts.size() && i < this.maxLineCount; ++i) {
            String text = (String) breakLineTexts.get(i);
    ...
    private java.util.List<String> computeLines(String text) {
