...
public class ImagePainter implements IPainter {
    ...
    public void draw(Graphics2D g, CombineElement element, int canvasWidth) throws Exception {
        ...
        if (imageElement.getRotate() != null) {
            g.rotate(Math.toRadians((double) imageElement.getRotate()), (double) (imageElement.getX() + imageElement.getWidth() / 2), (double) (imageElement.getY() + imageElement.getHeight() / 2));
        }

        g.setComposite(AlphaComposite.getInstance(3, imageElement.getAlpha()));
        g.drawImage(image, imageElement.getX(), imageElement.getY(), width, height, (ImageObserver) null);
        if (imageElement.getRotate() != null) {
            g.rotate(-Math.toRadians((double) imageElement.getRotate()), (double) (imageElement.getX() + imageElement.getWidth() / 2), (double) (imageElement.getY() + imageElement.getHeight() / 2));
        }
