...
public class GetForumsRivenDispositionUpdates {
     ...
     * @return Url地址
     */
    private static String getRivenDispositionUpdateUrl(String key) throws UnsupportedEncodingException {
        String html;
        if (StringUtils.isHttpUrl(key) && key != null && !key.equals("")) {
            ...
            if (!Objects.equals(key, "") && key != null) {
                ...
                html = HttpUtils.sendGetOkHttp(
                        "https://forums.warframe.com/search/?&q=Riven%20Disposition%20Updates&quick=1&search_and_or=and&search_in=titles&sortby=relevancy");
            }
        }
        //返回变量
        String newRiven = "";
    ...
    public static List<WarframeRivenTrend> getRivenDispositionUpdates(String urlStr) throws UnsupportedEncodingException {
        //获取文档Url地址
        String url = getRivenDispositionUpdateUrl(urlStr);
        //用于存放返回的结果
