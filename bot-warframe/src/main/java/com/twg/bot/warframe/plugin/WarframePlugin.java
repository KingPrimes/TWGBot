...
public class WarframePlugin extends BotPlugin {
    ...
    public int onGroupMessage(@NotNull Bot bot, @NotNull GroupMessageEvent event) {
        ...
        if ("取消订阅".equals(StringUtils.substring(event.getRawMessage(), 0, "取消订阅".length()))) {
            ...
            final var subscribe1 = new WarframeMissionSubscribe(event.getGroupId(), "", bot.getSelfId(), enums.ordinal());
            final var subscribes = service.selectWarframeMissionSubscribeList(subscribe1);
        ...
        if ("取消私人订阅".equals(StringUtils.substring(event.getRawMessage(), 0, "取消私人订阅".length()))) {
            ...
            final var subscribe1 = new WarframeMissionSubscribe(event.getGroupId(), String.valueOf(event.getUserId()), bot.getSelfId(), enums.ordinal());
